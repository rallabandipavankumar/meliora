...
::-webkit-scrollbar-thumb:hover {
  background: orangered; 
	...
	<div class="top-frame">
        <div class="logo">
        <img src="C:\Users\PURANDESWARI\OneDrive\Pictures\Saved Pictures\logo1.jpg" alt="Your Logo" height="75px"></div>
        <div class="title">
        <h3>EduCare Connect</h3>
        </div>
    </div>
    <div class="bottom-frame">
        <div class="left-frame">
            <div class="left-menu-item" onclick="dashboard()">Home</div>
            ...
            <div class="left-menu-item" onclick="completed()" style="display:none;">Completed</div>
            <div class="left-menu-item" onclick="inpro()" style="display:none;">Inprogress</div>
            <div class="left-menu-item" onclick="pending()" style="display:none;">Pending</div>
            <div class="left-menu-item" onclick="history()" style="display:none;">History</div>
			<div class="left-menu-item" onclick="editinfo()" style="display:none;">Edit Profile</div>
			<div class="left-menu-item" onclick="changepass()" style="display:none;">Change Password</div>
        </div>
