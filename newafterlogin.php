  ...
  <link rel="stylesheet" href="main.css">
	...
	<nav class="navbar-nav navbar-expand-sm bg-dark">
		...
		<h3 style="color:white"><?php echo $fname." ".$lname; ?></h3>
			...
			<div class="nav-item"  style="margin-left:50%;">
			<a class="btn" title="Click to Logout" href="userlogin1.html">LOGOUT</a>
		</div>
		</nav>
		<nav  class="navbar" style="float:left;margin-top:0px;display:block;
				background-color:black;" id="sh_menu">
			<!-- Links -->
  <ul class="navbar-nav" style="width:100%;background-color:black;">
			  <li class="nav-item" >			
		<img src="user.png" width="90px" height="80px">
		   </li>
    <li class="nav-item"  >
      <a class="btna btn-dark btn1" onclick="dashboard()" href="#">Dashboard</a>
    </li>
    <li class="nav-item">
      <a class="btna btn-dark btn1" onclick="comp()" href="#">Complaint</a>
    </li>
	 <li class="nav-item" style="display:none;" id="m_comp">
      <a class="btna btn-dark btn1" onclick="makecomplaint()" href="#">Make Complaint</a>
    </li>
	
    <li class="nav-item" >
      <a class="btna btn-dark btn1" onclick="completed()" style="display:none;" id="c_comp" href="#">Completed</a>
    </li>
	
    <li class="nav-item" >
      <a class="btna btn-dark btn1" onclick="inpro()" style="display:none;" id="i_comp" href="#">Inprogress</a>
    </li>
    <li class="nav-item" >
      <a class="btna btn-dark btn1" onclick="pending()" style="display:none;" id="p_comp" href="#">Pending</a>
    </li>
	<li class="nav-item" >
      <a class="btna btn-dark btn1" onclick="history()" style="display:none;" id="h_comp" href="#">Complaint history</a>
    
	</li>
	    <li class="nav-item" >
      <a class="btna btn-dark btn1" onclick="personal()" href="#">Personal Info</a>
    </li>
	    <li class="nav-item">
      <a class="btna btn-dark btn1" onclick="editinfo()" style="display:none;" id="e_info" href="#">Edit Info</a>
    </li>
	    <li class="nav-item">
      <a class="btna btn-dark btn1" onclick="changepass()" style="display:none;" id="c_pass" href="#">Change password</a>
    </li>
